...
describe('CartItem Component', () => {
  ...
  describe('Rendering', () => {
    ...
    it('renders variant color indicator', () => {
      render(
        <TestQueryClient>
          <CartItem cartItem={mockCartItem} />
        </TestQueryClient>,
    ...
    it('renders correct variant information', () => {
      render(
        <TestQueryClient>
  ...
  describe('Error State', () => {
    ...
    it('should render Try Again button and handle click in error state', () => {
      mockUseGetProductDetail.mockReturnValue({
        data: undefined,
        isPending: false,
        isError: true,
  ...
  describe('Quantity Management', () => {
    ...
    it('handles minimum quantity of 1', () => {
      render(
        <TestQueryClient>
          <CartItem cartItem={mockCartItem} />
        </TestQueryClient>,
    ...
    it('handles maximum quantity of 100', () => {
      render(
        <TestQueryClient>
          <CartItem cartItem={mockCartItem} />
        </TestQueryClient>,
  ...
  describe('Variant Handling', () => {
    it('uses correct variant image when variant exists', () => {
      render(
        <TestQueryClient>
          <CartItem cartItem={mockSecondCartItem} />
        </TestQueryClient>,
    ...
    it('displays correct variant color', () => {
      render(
        <TestQueryClient>
          <CartItem cartItem={mockSecondCartItem} />
        </TestQueryClient>,
